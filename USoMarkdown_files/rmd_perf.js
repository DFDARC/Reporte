...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 140460 }, { marker: 'pandoc', elapsed: 640 }, { marker: 'post-processor', elapsed: 90 }, { marker: 'pre-processor', elapsed: 20 }, { marker: 'render', elapsed: 142150 } ];
